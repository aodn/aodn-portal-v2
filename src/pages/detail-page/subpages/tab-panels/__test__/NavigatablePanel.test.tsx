...
describe("NavigatablePanel", () => {
  ...
  it("renders AIGenTag icon when AIGenContent is provided", () => {
    const mockAIGenContent: InfoContentType = {
    ...
    render(
      <ThemeProvider theme={AppTheme}>
        <NavigatablePanel
          ...
          isLoading={false}
          AIGenContent={mockAIGenContent}
        />
      </ThemeProvider>
    );

    expect(screen.getByTestId("AIGenTag-icon")).toBeInTheDocument();
  });

  it("does not render AIGenTag icon when AIGenContent is not provided", () => {
    render(
      <ThemeProvider theme={AppTheme}>
        <NavigatablePanel childrenList={mockChildren} isLoading={false} />
      </ThemeProvider>
    ...
    expect(screen.queryByTestId("AIGenTag-icon")).not.toBeInTheDocument();
  });
});
