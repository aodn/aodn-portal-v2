...
import { DataUsageInformation } from "../components/download/DownloadDialog/DataUsageForm";
...
export const useDownloadDialog = (
  ...
  // ================== TRY AVOID REF eslint CHECK indicate bad coding ==================
