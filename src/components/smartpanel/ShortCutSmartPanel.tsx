...
const ShortCutSmartPanel = (props: ShortCutSmartPanelProps) => {
    return(
        <ComplexSmartPanel rows={2} columns={9}>
            ...
            <SmartCard22 caption='Surface Waves' underline='Surface Temperature Current Velocity ' imageUrl='/smartcard/wave.png' onCardClicked={(e) => props.onCardClicked && props.onCardClicked(CARD_ID.SURFACE_WAVES, e)}/>
            ...
            <SmartCard11 caption='Tutorials' imageUrl='/smartcard/tutorials.png' onCardClicked={(e) => props.onCardClicked && props.onCardClicked(CARD_ID.TUTORIAL, e)}/>
            ...
            <SmartCard11 caption='Ocean Biota' imageUrl='/smartcard/ocean_biota.png' onCardClicked={(e) => props.onCardClicked && props.onCardClicked(CARD_ID.OCEAN_BIOTA, e)}/>
