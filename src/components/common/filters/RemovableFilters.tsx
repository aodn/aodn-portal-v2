  ...
  return (
    <Collapse orientation="vertical" in={props.showFilters}>
      <Grid container gap={2} justifyContent={"center"}>
        ...
        <Grid item xs={8}>
          <RemovableParameterFilter title="Parameter" url="/filters/tune.png" />
        </Grid>
        <Grid item xs={8}>
          <RemovableParameterFilter
            title="Platform"
            url="/filters/platform.png"
          />
        </Grid>
        <Grid item xs={8}>
          <RemovableParameterFilter
            title="Organization"
            url="/filters/organization.png"
          />
        </Grid>
        <Grid item xs={8}>
          <RemovableParameterFilter title="Data" url="/filters/data.png" />
        </Grid>
        {
