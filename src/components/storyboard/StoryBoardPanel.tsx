...
import NotebookModel, {NotebookModelCallbackProps, NotebookModelProps} from "../common/ipython/NotebookModel";

const StoryBoardPanel = () => {

    const [value, setValue] = React.useState(0);
    const [notebook, setNotebook] = React.useState<NotebookModelProps>({showDialog:false})
                    ...
                    >
                        <Grid item xs={8}>
                            <StoryBoard
                                        ...
                                        caption='Data Story 01 : OceanHackWeek 2023: Data Access - Marty Hidas'
