...
const NORMAL_COLLECTION = {
  ...
  links: [
    ...
    {
      href: "uuid:c46ea3a7-1279-4e5d-8fb7-c1c2440fc5c8",
      rel: "parent",
      type: "application/json",
      title:
        '{"title":"AIMS Automated Weather and Oceanographic Stations Program","recordAbstract":"Parent program record covering all AIMS automated weather and oceanographic stations, of which the Northern Australia network is one sub-program."}',
    },
    {
