/**
 * The title contains json where it is malformed, a negative test to make sure FE not crash
 */
const COLLECTIONS_MALFORM_RELATED = {
  properties: {
    geometry: {
      geometries: [
        {
    ...
    contacts: [
      {
        ...
        position: "Marine Spatial Analyst",
        emails: ["tessa.mazor@delwp.vic.gov.au"],
        addresses: [
          {
            city: "Melbourne",
            country: "Australia",
        ...
        roles: ["processor", "about"],
      },
      {
        name: "Grinter, Vincent",
        organization:
          "Department of Environment, Land, Water and Planning (DELWP), Victorian Government",
        position: "Data Applications Offier",
        emails: ["vincent.grinter@delwp.vic.gov.au"],
        addresses: [
          {
            city: "Melbourne",
            country: "Australia",
      ...
      },
      {
        ...
        emails: ["IMAS.DataManager@utas.edu.au"],
      ...
      },
      {
        ...
        roles: ["resourceProvider", "metadata"],
      },
      {
        organization:
          "Department of Environment, Land, Water and Planning (DELWP), Victorian Government",
    ...
    themes: [
      ...
      },
      {
        ...
        concepts: [
          {
            id: "EARTH SCIENCE | BIOSPHERE | ECOSYSTEMS | MARINE ECOSYSTEMS | BENTHIC",
            url: "http://gcmd.earthdata.nasa.gov/kms/concept/09a78997-581b-4d1b-ae71-b2b3f96ef719",
            description: "Earth Science Keywords",
            title: "GCMD Keywords, Version 8.5",
          },
          {
            id: "EARTH SCIENCE | OCEANS | BATHYMETRY/SEAFLOOR TOPOGRAPHY | BATHYMETRY | COASTAL BATHYMETRY",
            url: "http://gcmd.earthdata.nasa.gov/kms/concept/d80c015f-a383-4883-8309-6aab1c39f5b6",
            description: "Earth Science Keywords",
            title: "GCMD Keywords, Version 8.5",
          },
        ],
  ...
  title: "Victorian Statewide Marine Habitat Map 2023",
  description:
  ...
  links: [
    ...
    {
      href: "https://metashare.maps.vic.gov.au/geonetwork/srv/api/records/2b7471bd-523a-5d66-b805-abc8ad650c50",
      rel: "related",
      type: "text/html",
      title: "Original metadata record [Victorian Government catalogue]",
      "ai:group": "Other",
    },
    {
      href: "https://geonetwork.edge.aodn.org.au:443/geonetwork/images/logos/1bb8f09c-99d6-431f-b902-4d3e4cef02df.png",
      rel: "icon",
      type: "image/png",
      title: "Suggest icon for dataset",
    },
    {
      href: "https://metadata.imas.utas.edu.au/geonetwork/srv/api/records/0145df96-3847-474b-8b63-a66f0e03ff54/attachments/DELWP.jpg",
      rel: "preview",
      type: "image",
    },
    {
      href: "https://metadata.imas.utas.edu.au/geonetwork/srv/eng/catalog.search#/metadata/0145df96-3847-474b-8b63-a66f0e03ff54",
      rel: "describedby",
      type: "text/html",
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Reefs and shoals - Queensland","recordAbstract":"This dataset displays the reefs and shoals within Queensland maritime waters.\\n\\nNames have been sourced from numerous locations and attributes within the data describe the source of the names. Name sources include but not limited to:\\n- Queensland Place Names Database\\n- Great Barrier Reef Base Mapping\\n- Geoscience Australia 1:100000 Topographic Mapping"}',
    },
    {
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Moreton Bay coral 2004","recordAbstract":"Benthic habitat mapping of Moreton Bay, from Comboyuro Point to Jacobs Well. Mapping conducted as part of the Ecosystem Health Monitoring Program."}',
    },
    {
      href: "uuid:0985c77d-5b2e-498b-9016-bfcce78df2da",
      rel: "sibling",
      type: "application/json",
      title:
        '{"title":"Jurien Bay benthic habitat mapping","recordAbstract":"Jurien Bay Boat Harbour is located north of the town of Jurien Bay, ~250 km north of Perth, Western Australia. The Boat Harbour services a range of government, recreational and commercial vessels and is managed by the WA Department of Transport (DoT).\\n\\nWrack and marine sediments frequently accumulate in the Boat Harbour, negatively affecting the navigability, environment and aesthetic quality of the Harbour. To manage these impacts, routine maintenance dredging is undertaken by DoT.\\n\\nTo inform future dredging requirements and marine environmental management of the Boat Harbour, BMT undertook benthic habitat mapping of Jurien Bay in November 2017 on behalf of DoT. The objectives of the mapping project were to:\\ni. collect baseline data on the spatial extent and characteristics of benthic habitats in the mapping area, and\\nii. qualitatively characterise the extent of benthic primary producer habitat surrounding the Boat Harbour, and develop a mapping product to inform dredging operations and potential future environmental approvals applications, if necessary.\\n\\nMapping was conducted by first collating satellite imagery to identify benthic habitat features to be ground-truthed by towed video. Video footage was annotated with biological attributes and combined with the satellite imagery to create classified benthic habitat maps of an area offshore of the Boat Harbour.\\n\\nSee the \\"Lineage\\" section of this record and attached survey report for detailed methodology."}',
    },
    {
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Queensland wetland data v4 - wetland areas","recordAbstract":"This dataset provides mapping of water bodies and wetland regional ecosystems at 1:100,000 scale across Queensland."}',
    },
    {
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Seagrass meadows of Arnhem Land, Kakadu and Gulf of Carpentaria","recordAbstract":"This is a collection of polygons outlining signficant seagrass meadows around Arnhem Land, Kakadu and Gulf of Carpentaria coastal waters for the Northern Australia Marine Biodiversity Survey (NAMBS) project between 2003 and 2005. Data was collected from imagery and ground truthed by observers from helicopter and insitu sample grabs."}',
    },
    {
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Ludmilla Creek Vegetation Survey","recordAbstract":"This is a high resolution survey (1:5,000 scale dataset) describing mapped vegetation communities for the Ludmilla Creek catchment area (within the City of Darwin, Northern Territory).\\n(Vegetation Unit - A reasonably homogeneous part of the land surface, distinct from surrounding terrain with constant properties in landform and vegetation)\\n\\nThis vegetation survey was undertaken in 1996. This dataset represents the vegetation on the ground at the time of the survey and reflects the data and methods used to create the mapped polygons. The dataset has been revised in 2015 to include community descriptions but has not been updated to reflect the vegetation on the ground. The Darwin Remnant Vegetation Survey is considered a more up-to-date representation of vegetation for this area."}',
    },
    {
      href: "uuid:6eb8ab22-6ba4-4c5a-8454-73e279f751f0",
      rel: "sibling",
      type: "application/json",
      title:
        '{"title":"Franklin and Zeehan Marine Park fine-scale seafloor substrate mapping","recordAbstract":"Fine-scale bathymetry mapping was conducted in the Franklin and Zeehan Australian Marine Parks (AMPs) located off the west coast of Tasmania, Australia. The primary objective of this mapping exercise was to map seafloor features of the shelf areas of these AMPs for the first time and to understand the distribution of benthic habitats and key sessile invertebrate species within these areas.\\n\\nCharacterisation of the seafloor was undertaken in two phases. The first stage used multibeam sonar to comprehensively map the study areas, extracting bathymetry and backscatter products. This was followed by extensive ground validation undertaken by a panoramic stereo drop-camera system that also recorded the presence of dominant sessile invertebrate fauna as well as benthic/demersal fish species.\\n\\nThis record describes and provides data access to the fine-scale substratum mapping extracted from the combination of multibeam bathymetry and video ground-truthing data. Access to the (1) bathymetry survey data; and (2) annotated seafloor imagery, are provided through the \'Download and Links\' section of this record."}',
    },
    {
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Darwin Harbour marine habitats","recordAbstract":"This data was collected to improve our knowledge and understanding of the marine environment in the upper reaches of East and Middle Arms (Darwin Harbour), to assist planning and sustainable development for the new township. \\n\\nData provide polygon data that map the benthic habitats (12 physical and biological categories) in the upper reaches of the harbour using remote-sensed and survey data.\\n\\nThis dataset is being continually updated and is current as of 03/03/2016."}',
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Changes in seagrass coverage in Cockburn Sound, Western Australia between 1967 and 1999","recordAbstract":"Changes in seagrass coverage in Cockburn Sound from 1967 to 1999 were assessed from aerial photographs using modern mapping methods with the aim of accurately determining the magnitude of change in hectares of seagrasses between 1967 and 1999."}',
    },
    {
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"Mapping of selected areas of Cockburn Sound, Western Australia","recordAbstract":"In 2002, aerial photography of the Perth metropolitan coastal waters was purpose-flown to obtain high quality imagery of the benthic habitats. This imagery was used to map the coverage of vegetated areas in two selected areas of Cockburn Sound: Southern Flats and Eastern Shoal. Areas of relatively poor visibility, such as the Eastern Shelf, are difficult to map with confidence using these techniques. A ground-truthing survey was undertaken in 2004 to map the seagrass and reef habitats on the Eastern Shelf utilising sidescan sonar, towed video and spot dives."}',
    },
    {
    ...
    },
    {
      ...
      type: "application/json",
      title:
        '{"title":"CAMRIS Marine Benthic Substrate Database - Marsed","recordAbstract":"This database contains information about the distribution of 10 different types of sea floor sediment in the Australian region. It was derived from data collected and mapped by the Ocean Sciences Institute, University of Sydney."}',
    },
    {
    ...
    {
      href: "uuid:f0df1c23-455f-4520-bd4f-fd06d8ef60a1",
      rel: "sibling",
      type: "application/json",
      title:
        '{"title":"Very High Resolution Seafloor Classification and Satellite Derived Bathymetry of Lancelin, Australia (IMSA)","recordAbstract":"Mapping of benthic habitat and seafloor bathymetry of Lancelin, WA derived from satellite imagery captured on 17 July 2017 at a spatial resolution of 2 m. \\n\\nMapping extent covered as much of the Defence gazetted waters as possible, to a depth of approximately 18 m based on water clarity. Recently dead or senesced (e.g. winter dieback of leaves) and mobile seagrass have the same satellite signature as live seagrass at spectral resolutions of the sensor (WorldView-2). This ensured areas of winter dieback and/or senescence were captured as areas of seagrass for the purposes of impact assessment."}',
    },
    {
      href: "uuid:dec073c6-0bdc-44b0-83da-48bc1042a93e",
      rel: "sibling",
      type: "application/json",
      title:
        '{"title":"Satellite-Derived Bathymetry and Seafloor Habitat Classification Mapping of Cocos (Keeling) Islands Marine Park","recordAbstract":"Parks Australia - Indian Oceans Territory (IOT) Grants Project: Satellite-Derived Bathymetry and Seafloor Habitat Classification Mapping of Cocos (Keeling) Island Marine Park\\n\\nThis project mapped Satellite-derived Bathymetry (SDB) and seafloor habitats at 2m horizontal spatial resolution, for the shallow waters (~0-25 m) of the Cocos (Keeling) Islands Marine Park. SDB data was processed using EOMAP\'s proprietary software and algorithm package Watcor-X, which generates SDB using multipspectral satellite data. The SDB is based on the physics-based inversion method of the radiative transfer equation which models the pathway of light and its interaction through different media (e.g. atmosphere and water column). The thematic classification of the seabed was based on multispectral satellite image analytics. Satellite imagery was pre-processed by applying a set of image correction procedures to reduce environmental noise, resulting in a standardised reflectance surface of the subsurface and seafloor. The information on seafloor reflectance at different wavelengths was used to run an object-based classification procedure which groups objects of similar spectral characteristics, shape and texture into different classes of major seafloor habitat type.\\n\\nThese critical geospatial data layers provide the essential environmental baseline information for the long-term monitoring and management of the IOT Marine Parks. Having access to digital, georeferenced, high-resolution, satellite-derived maps of bathymetry and benthic habitats of shallow water areas, is of fundamental use in the areas of navigation and safety-at-sea, ecological research, environmental modelling, management and conservation, and monitoring the impacts from climate change."}',
    },
    {
...
export { COLLECTIONS_MALFORM_RELATED };
