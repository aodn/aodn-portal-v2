...
def test_citation_and_usage_sections_in_desktop(
    desktop_page: Page,
    title: str,
    uuid: str,
    ...
    """
    Verifies that the 'Citation and Usage' tab correctly scrolls to and
...
def test_citation_and_usage_sections_in_mobile(
    mobile_page: Page,
    title: str,
    uuid: str,
    suggested_citation: str,
